      ...
      render: (item) => {
        ...
        return (
          <div className="flex flex-col items-start gap-2">
            <div className={`stock-badge ${badgeClass}`}>{item.stock} Quantity</div>
            ...
            <div className="custom-modal max-w-md w-full">
              <div className="modal-header flex justify-between items-start mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    {editingItem.product_name} <span className="text-xs text-gray-400">(ID: {editingItem.product_id})</span>
                  </p>
                </div>
                <button
              ...
              >
                <div className="form-grid mb-6">
                  <div>
                    <p className="form-label font-bold">Current Stock</p>
                    <div className="form-value-box">{editingItem.stock}</div>
                  </div>
                  <div>
                    <p className="form-label font-bold">Current Threshold</p>
                    <div className="form-value-box">{editingItem.low_stock_threshold}</div>
                  </div>
                </div>
                <div className="form-group">
                  <label className="form-label font-bold" htmlFor="new_threshold">
                    New Threshold
                  </label>
                  <Input
                    id="new_threshold"
                  ...
                  <small className="text-gray-500">
                    Set the minimum stock before this item is considered "low stock".
                  </small>
                </div>
          ...
          <div className="custom-modal-overlay">
            <div className="custom-modal max-w-md w-full">
              ...
              <div className="item-details form-grid mb-6">
                ...
                <div>
                  <p className="form-label font-bold">Low Stock Threshold</p>
                  <p className="text-gray-900 dark:text-white">{viewItem.low_stock_threshold}</p>
                </div>
                <div>
                  <p className="form-label font-bold">Last Updated</p>
